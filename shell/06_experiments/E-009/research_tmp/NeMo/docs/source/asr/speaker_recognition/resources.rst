...
`the speaker recognition tutorials folder <https://github.com/NVIDIA-NeMo/Speech/tree/stable/tutorials/speaker_tasks/>`_. This and most other tutorials can be run on Google Colab by specifying the link to the notebooks' GitHub pages on Colab.
...
For a clear step-by-step tutorial we advise you to refer to the tutorials found in `folder <https://github.com/NVIDIA-NeMo/Speech/tree/stable/tutorials/speaker_tasks/>`_.
