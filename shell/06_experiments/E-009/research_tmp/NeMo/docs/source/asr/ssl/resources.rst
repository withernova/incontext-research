...
Refer to `SSL-for-ASR notebook <https://github.com/NVIDIA-NeMo/Speech/tree/stable/tutorials/asr/Self_Supervised_Pre_Training.ipynb>`_
for a hands-on tutorial. If you are a beginner to NeMo, consider trying out the 
`ASR with NeMo <https://github.com/NVIDIA-NeMo/Speech/tree/stable/tutorials/asr/ASR_with_NeMo.ipynb>`_
