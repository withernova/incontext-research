...
`config directory of the examples <https://github.com/NVIDIA-NeMo/Speech/tree/stable/examples/tts/conf>`_.
...
<https://github.com/NVIDIA-NeMo/Speech/tree/stable/nemo/collections/tts/data/dataset.py>`_  can be set in the config
...
There are multiple TTS model finetuning scripts in `examples/tts/<model>_finetune.py <https://github.com/NVIDIA-NeMo/Speech/tree/stable/examples/tts/>`_. You can finetune any model by substituting the ``<model>`` tag. An example of finetuning a HiFiGAN model is shown below.
