...
_TRAINERSPEC_MODELTYPE = _descriptor.EnumDescriptor(
    ...
    file=DESCRIPTOR,
    values=[
        _descriptor.EnumValueDescriptor(name='UNIGRAM', index=0, number=1, serialized_options=None, type=None),
        _descriptor.EnumValueDescriptor(name='BPE', index=1, number=2, serialized_options=None, type=None),
        _descriptor.EnumValueDescriptor(name='WORD', index=2, number=3, serialized_options=None, type=None),
        _descriptor.EnumValueDescriptor(name='CHAR', index=3, number=4, serialized_options=None, type=None),
    ],
...
_MODELPROTO_SENTENCEPIECE_TYPE = _descriptor.EnumDescriptor(
    ...
    file=DESCRIPTOR,
    values=[
        _descriptor.EnumValueDescriptor(name='NORMAL', index=0, number=1, serialized_options=None, type=None),
        _descriptor.EnumValueDescriptor(name='UNKNOWN', index=1, number=2, serialized_options=None, type=None),
        _descriptor.EnumValueDescriptor(name='CONTROL', index=2, number=3, serialized_options=None, type=None),
        _descriptor.EnumValueDescriptor(name='USER_DEFINED', index=3, number=4, serialized_options=None, type=None),
        _descriptor.EnumValueDescriptor(name='BYTE', index=4, number=6, serialized_options=None, type=None),
        _descriptor.EnumValueDescriptor(name='UNUSED', index=5, number=5, serialized_options=None, type=None),
    ],
    containing_type=None,
    serialized_options=None,
...
_TRAINERSPEC = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name='pretokenization_delimiter',
            full_name='sentencepiece.TrainerSpec.pretokenization_delimiter',
            index=27,
            number=53,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='seed_sentencepieces_file',
            full_name='sentencepiece.TrainerSpec.seed_sentencepieces_file',
            index=45,
            number=54,
            type=9,
            cpp_type=9,
