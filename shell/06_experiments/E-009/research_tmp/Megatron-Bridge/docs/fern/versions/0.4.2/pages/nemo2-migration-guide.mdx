...
|----------|-----------------|
| `llm.Llama3Config8B` | `bridge.models.Llama3ModelProvider8B` |
| `llm.Llama31Config70B` | `bridge.models.Llama31ModelProvider70B` |
| `llm.Qwen2Config7B` | `bridge.models.Qwen2ModelProvider7B` |
