...
cfg.logger.tensorboard_dir = "/results/olmoe_7b/tb_logs"
cfg.checkpoint.save = "/results/olmoe_7b/checkpoints"
...
cfg.logger.tensorboard_dir = "/results/olmoe_7b/sft/tb_logs"
cfg.checkpoint.save = "/results/olmoe_7b/sft/checkpoints"
cfg.checkpoint.pretrained_checkpoint = "/results/olmoe_7b/checkpoints/iter_0500000"
...
cfg = olmoe_7b_peft_config(peft_scheme="lora")  # or "dora" for DoRA
cfg.tokenizer.tokenizer_model = "allenai/OLMoE-1B-7B-0125"
cfg.logger.tensorboard_dir = "/results/olmoe_7b/peft/tb_logs"
cfg.checkpoint.save = "/results/olmoe_7b/peft/checkpoints"
cfg.checkpoint.pretrained_checkpoint = "/results/olmoe_7b/checkpoints/iter_0500000"
cfg.train.train_iters = 1000
cfg.train.global_batch_size = 128
