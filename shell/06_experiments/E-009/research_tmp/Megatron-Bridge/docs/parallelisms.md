...
[parallelism strategies skill](skills/nemo-mbridge-perf-parallelism-strategies/SKILL.md).
...
- **Operational skill**: [skills/nemo-mbridge-perf-parallelism-strategies/SKILL.md](skills/nemo-mbridge-perf-parallelism-strategies/SKILL.md) — enablement, pitfalls, memory estimation, verification
- **Knowledge card**: [skills/nemo-mbridge-perf-parallelism-strategies/card.yaml](skills/nemo-mbridge-perf-parallelism-strategies/card.yaml) — structured metadata and validation status
