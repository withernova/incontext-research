...
#SBATCH --job-name=nomni-sft-cord-v2
#SBATCH --nodes=2
...
#SBATCH --output=nomni_sft_cord_v2_%j.out
#SBATCH --error=nomni_sft_cord_v2_%j.err
#SBATCH --exclusive
...
echo "======================================"
echo "Nemotron-3 Nano Omni - SFT (CORD-V2)"
echo "======================================"
...
CLI_OVERRIDES="\
    ...
    logger.wandb_exp_name=${RECIPE}_sft"
