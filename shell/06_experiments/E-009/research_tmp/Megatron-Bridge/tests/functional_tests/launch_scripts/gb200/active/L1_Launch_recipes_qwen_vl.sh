...
# This script tests Qwen2.5-VL, Qwen3-VL, and Qwen3.5-VL recipe configurations
# with their default settings to ensure they can run basic training without crashes.
