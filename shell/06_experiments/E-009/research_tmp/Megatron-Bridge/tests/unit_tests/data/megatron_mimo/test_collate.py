...
"""Unit tests for MegatronMIMO collate functions."""
...
class TestMegatronMIMOCollateFn:
    """Test suite for megatron_mimo_collate_fn."""

    def test_basic_collation(self):
        """Test basic batch collation."""
        batch = [make_sample() for _ in range(4)]

        result = megatron_mimo_collate_fn(batch, modality_names=["vision"])
    ...
    def test_multiple_modalities(self):
        ...
        result = megatron_mimo_collate_fn(batch, modality_names=["vision", "audio"])
    ...
    def test_empty_batch(self):
        ...
        result = megatron_mimo_collate_fn([], modality_names=["vision"])
        assert result == {}
