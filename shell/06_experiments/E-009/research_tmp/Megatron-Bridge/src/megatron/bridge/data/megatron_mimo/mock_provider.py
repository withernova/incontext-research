...
class MockMegatronMIMOProvider(MegatronMIMODatasetProvider):
    """DatasetProvider for mock MegatronMIMO datasets with synthetic multimodal data.
    ...
    ) -> Tuple[Optional[MegatronMIMODataset], Optional[MegatronMIMODataset], Optional[MegatronMIMODataset]]:
