...
def megatron_mimo_collate_fn(
    ...
    suitable for MegatronMIMO model forward pass.

    Args:
        batch: List of examples from MegatronMIMODataset, each containing:
    ...
    Example:
        ...
        ...     # ... more examples
        ... ]
        >>> collated = megatron_mimo_collate_fn(batch, modality_names=["vision"])
    """
    if not batch:
        return {}
