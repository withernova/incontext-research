...
"""HuggingFace dataset provider for MegatronMIMO multi-encoder models."""
...
class HFMegatronMIMODatasetProvider(MegatronMIMODatasetProvider):
    """DatasetProvider for MegatronMIMO models using HuggingFace datasets.
    ...
    that MegatronMIMO encoder modules consume during training.

    For testing with synthetic data, use MockMegatronMIMOProvider instead.
    ...
    def get_collate_fn(self) -> Callable:
        """Return collate function for MegatronMIMO datasets.

        Returns:
            Partial function of megatron_mimo_collate_fn with modality names pre-filled.
        """
        return partial(
