...
@dataclass
class FalconH1StackSubmodules:
    """
    A class for the module specs for the FalconH1Stack.
    """

    mamba_layer: Union[ModuleSpec, type] = IdentityOp
    attention_layer: Union[ModuleSpec, type] = IdentityOp
    mlp_layer: Union[ModuleSpec, type] = IdentityOp
    falconh1_layer: Union[ModuleSpec, type] = IdentityOp


class FalconH1Stack(MegatronModule):
    """
    Constructor for the FalconH1Stack class.

    Args:
        config (FalconH1Config): the model configuration
        submodules (FalconH1StackSubmodules): the submodules for the stack
        ...
        falconh1_ratio (float, optional): the target ratio of parallel hybrid layers
    ...
    def __init__(
        ...
        assert pg_collection is not None, "pg_collection must be provided for FalconH1Stack"
    ...
    def forward(
        ...
        *,
        ...
        """
        Forward function of the FalconH1Stack class.
