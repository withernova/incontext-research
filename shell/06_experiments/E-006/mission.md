...
## 强制启动顺序（事实优先）
1. 运行 `python3 /Users/saul/Tools/survey-tool/surveyctl.py --project /Users/saul/Project/NKU-MASTER/Projects/26-CVPR/incontext experiment context E-006`，读取其中已登记的 `server.ssh_host` 与 Workspace 路径。
...
5. `draft` 阶段只勘察，不修改代码、不启动测试。勘察后生成 `/tmp/E-006-handoff.json` 并运行 `surveyctl experiment handoff E-006 --file /tmp/E-006-handoff.json`。格式必须为：
```json
...
- 记录发现：`python3 /Users/saul/Tools/survey-tool/surveyctl.py --project /Users/saul/Project/NKU-MASTER/Projects/26-CVPR/incontext event E-006 --type discovery --message <verified-fact> --details <path-or-output-summary>`。
...
## Canonical 路径
- 实验方案：/Users/saul/Project/NKU-MASTER/Projects/26-CVPR/incontext/shell/06_experiments/E-006/plan.md
- Runs：/Users/saul/Project/NKU-MASTER/Projects/26-CVPR/incontext/shell/06_experiments/E-006/runs
- 活动记录：/Users/saul/Project/NKU-MASTER/Projects/26-CVPR/incontext/shell/06_experiments/E-006/events.md
